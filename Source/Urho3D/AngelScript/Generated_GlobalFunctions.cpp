...
// const Vector<String>& ParseArguments(const String& cmdLine, bool skipFirstArgument=true) | File:
// ../Core/ProcessUtils.h
...
// bool writeLightmapUV=false) | File: ../Graphics/Drawable.h
static bool WriteDrawablesToOBJ_PODVectorDrawable_File_bool_bool_bool(CScriptArray* drawables, File* outputFile,
                                                                      bool asZUp, bool asRightHanded,
...
void ASRegisterGenerated_GlobalFunctions(asIScriptEngine* engine)
{
    ...
    // AllocatorBlock* AllocatorInitialize(unsigned nodeSize, unsigned initialCapacity=1) | File:
    // ../Container/Allocator.h Error: type "AllocatorBlock*" can not automatically bind void
    // AllocatorUninitialize(AllocatorBlock* allocator) | File: ../Container/Allocator.h Error: type "AllocatorBlock*"
    // can not automatically bind void* AllocatorReserve(AllocatorBlock* allocator) | File: ../Container/Allocator.h
    ...
    engine->RegisterGlobalFunction("void CombineHash(uint&, uint)",
                                   asFUNCTIONPR(CombineHash, (unsigned&, unsigned), void), asCALL_CDECL);
    // StringHashRegister& GetEventNameRegister() | File: ../Core/Object.h
    engine->RegisterGlobalFunction("StringHashRegister& GetEventNameRegister()",
                                   asFUNCTIONPR(GetEventNameRegister, (), StringHashRegister&), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("void ErrorDialog(const String&in, const String&in)",
                                   asFUNCTIONPR(ErrorDialog, (const String&, const String&), void), asCALL_CDECL);
    // void ErrorExit(const String& message=String::EMPTY, int exitCode=EXIT_FAILURE) | File: ../Core/ProcessUtils.h
    engine->RegisterGlobalFunction("void ErrorExit(const String&in = String::EMPTY, int = EXIT_FAILURE)",
                                   asFUNCTIONPR(ErrorExit, (const String&, int), void), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("void PrintUnicode(const String&in, bool = false)",
                                   asFUNCTIONPR(PrintUnicode, (const String&, bool), void), asCALL_CDECL);
    // void PrintUnicodeLine(const String& str, bool error=false) | File: ../Core/ProcessUtils.h
    engine->RegisterGlobalFunction("void PrintUnicodeLine(const String&in, bool = false)",
                                   asFUNCTIONPR(PrintUnicodeLine, (const String&, bool), void), asCALL_CDECL);
    // void PrintLine(const String& str, bool error=false) | File: ../Core/ProcessUtils.h
    engine->RegisterGlobalFunction("void PrintLine(const String&in, bool = false)",
                                   asFUNCTIONPR(PrintLine, (const String&, bool), void), asCALL_CDECL);
    // void PrintLine(const char* str, bool error=false) | File: ../Core/ProcessUtils.h
    // Error: type "const char*" can not automatically bind
    // const Vector<String>& ParseArguments(const String& cmdLine, bool skipFirstArgument=true) | File:
    // ../Core/ProcessUtils.h
    engine->RegisterGlobalFunction("Array<String>@ ParseArguments(const String&in, bool = true)",
                                   asFUNCTION(ParseArguments_String_bool), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("uint GetNumPhysicalCPUs()", asFUNCTIONPR(GetNumPhysicalCPUs, (), unsigned),
                                   asCALL_CDECL);
    // unsigned GetNumLogicalCPUs() | File: ../Core/ProcessUtils.h
    engine->RegisterGlobalFunction("uint GetNumLogicalCPUs()", asFUNCTIONPR(GetNumLogicalCPUs, (), unsigned),
                                   asCALL_CDECL);
    // void SetMiniDumpDir(const String& pathName) | File: ../Core/ProcessUtils.h
    engine->RegisterGlobalFunction("void SetMiniDumpDir(const String&in)",
                                   asFUNCTIONPR(SetMiniDumpDir, (const String&), void), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("uint64 GetTotalMemory()", asFUNCTIONPR(GetTotalMemory, (), unsigned long long),
                                   asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("bool ToBool(const String&in)", asFUNCTIONPR(ToBool, (const String&), bool),
                                   asCALL_CDECL);
    // bool ToBool(const char* source) | File: ../Core/StringUtils.h
    // Error: type "const char*" can not automatically bind
    // float ToFloat(const String& source) | File: ../Core/StringUtils.h
    engine->RegisterGlobalFunction("float ToFloat(const String&in)", asFUNCTIONPR(ToFloat, (const String&), float),
                                   asCALL_CDECL);
    // float ToFloat(const char* source) | File: ../Core/StringUtils.h
    // Error: type "const char*" can not automatically bind
    // double ToDouble(const String& source) | File: ../Core/StringUtils.h
    engine->RegisterGlobalFunction("double ToDouble(const String&in)", asFUNCTIONPR(ToDouble, (const String&), double),
                                   asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("int ToInt(const String&in, int = 10)",
                                   asFUNCTIONPR(ToInt, (const String&, int), int), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("uint ToUInt(const String&in, int = 10)",
                                   asFUNCTIONPR(ToUInt, (const String&, int), unsigned), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("int64 ToInt64(const String&in, int = 10)",
                                   asFUNCTIONPR(ToInt64, (const String&, int), long long), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("uint64 ToUInt64(const String&in, int = 10)",
                                   asFUNCTIONPR(ToUInt64, (const String&, int), unsigned long long), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("Color ToColor(const String&in)", asFUNCTIONPR(ToColor, (const String&), Color),
                                   asCALL_CDECL);
    // Color ToColor(const char* source) | File: ../Core/StringUtils.h
    // Error: type "const char*" can not automatically bind
    // IntRect ToIntRect(const String& source) | File: ../Core/StringUtils.h
    engine->RegisterGlobalFunction("IntRect ToIntRect(const String&in)",
                                   asFUNCTIONPR(ToIntRect, (const String&), IntRect), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("IntVector2 ToIntVector2(const String&in)",
                                   asFUNCTIONPR(ToIntVector2, (const String&), IntVector2), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("IntVector3 ToIntVector3(const String&in)",
                                   asFUNCTIONPR(ToIntVector3, (const String&), IntVector3), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("Quaternion ToQuaternion(const String&in)",
                                   asFUNCTIONPR(ToQuaternion, (const String&), Quaternion), asCALL_CDECL);
    // Quaternion ToQuaternion(const char* source) | File: ../Core/StringUtils.h
    // Error: type "const char*" can not automatically bind
    // Rect ToRect(const String& source) | File: ../Core/StringUtils.h
    engine->RegisterGlobalFunction("Rect ToRect(const String&in)", asFUNCTIONPR(ToRect, (const String&), Rect),
                                   asCALL_CDECL);
    // Rect ToRect(const char* source) | File: ../Core/StringUtils.h
    // Error: type "const char*" can not automatically bind
    // Vector2 ToVector2(const String& source) | File: ../Core/StringUtils.h
    engine->RegisterGlobalFunction("Vector2 ToVector2(const String&in)",
                                   asFUNCTIONPR(ToVector2, (const String&), Vector2), asCALL_CDECL);
    // Vector2 ToVector2(const char* source) | File: ../Core/StringUtils.h
    // Error: type "const char*" can not automatically bind
    // Vector3 ToVector3(const String& source) | File: ../Core/StringUtils.h
    engine->RegisterGlobalFunction("Vector3 ToVector3(const String&in)",
                                   asFUNCTIONPR(ToVector3, (const String&), Vector3), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("Vector4 ToVector4(const String&in, bool = false)",
                                   asFUNCTIONPR(ToVector4, (const String&, bool), Vector4), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("Variant ToVectorVariant(const String&in)",
                                   asFUNCTIONPR(ToVectorVariant, (const String&), Variant), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("Matrix3 ToMatrix3(const String&in)",
                                   asFUNCTIONPR(ToMatrix3, (const String&), Matrix3), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("Matrix3x4 ToMatrix3x4(const String&in)",
                                   asFUNCTIONPR(ToMatrix3x4, (const String&), Matrix3x4), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("Matrix4 ToMatrix4(const String&in)",
                                   asFUNCTIONPR(ToMatrix4, (const String&), Matrix4), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("String ToStringHex(uint)", asFUNCTIONPR(ToStringHex, (unsigned), String),
                                   asCALL_CDECL);
    ...
    // Error: type "PODVector<unsigned char>&" can not automatically bind
    // unsigned GetStringListIndex(const String& value, const String* strings, unsigned defaultIndex, bool
    // caseSensitive=false) | File: ../Core/StringUtils.h Error: type "const String*" can not automatically bind
    // unsigned GetStringListIndex(const char* value, const String* strings, unsigned defaultIndex, bool
    // caseSensitive=false) | File: ../Core/StringUtils.h Error: type "const char*" can not automatically bind unsigned
    // GetStringListIndex(const char* value, const char** strings, unsigned defaultIndex, bool caseSensitive=false) |
    // File: ../Core/StringUtils.h Error: type "const char*" can not automatically bind String ToString(const char*
    // formatString,...) | File: ../Core/StringUtils.h Error: type "const char*" can not automatically bind bool
    // IsAlpha(unsigned ch) | File: ../Core/StringUtils.h
    ...
    engine->RegisterGlobalFunction("String GetFileSizeString(uint64)",
                                   asFUNCTIONPR(GetFileSizeString, (unsigned long long), String), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("bool CompareDrawables(Drawable@+, Drawable@+)",
                                   asFUNCTIONPR(CompareDrawables, (Drawable*, Drawable*), bool), asCALL_CDECL);
    // bool WriteDrawablesToOBJ(const PODVector<Drawable*>& drawables, File* outputFile, bool asZUp, bool asRightHanded,
    // bool writeLightmapUV=false) | File: ../Graphics/Drawable.h
    engine->RegisterGlobalFunction("bool WriteDrawablesToOBJ(Array<Drawable@>@, File@+, bool, bool, bool = false)",
                                   asFUNCTION(WriteDrawablesToOBJ_PODVectorDrawable_File_bool_bool_bool), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("bool CompareLights(Light@+, Light@+)",
                                   asFUNCTIONPR(CompareLights, (Light*, Light*), bool), asCALL_CDECL);
    // void GenerateTangents(void* vertexData, unsigned vertexSize, const void* indexData, unsigned indexSize, unsigned
    // indexStart, unsigned indexCount, unsigned normalOffset, unsigned texCoordOffset, unsigned tangentOffset) | File:
    // ../Graphics/Tangent.h Error: type "void*" can not automatically bind
#ifdef URHO3D_IK
    // void RegisterIKLibrary(Context* context) | File: ../IK/IK.h
    // Context can be used as firs parameter of constructors only
#endif
    // unsigned EstimateCompressBound(unsigned srcSize) | File: ../IO/Compression.h
    engine->RegisterGlobalFunction("uint EstimateCompressBound(uint)",
                                   asFUNCTIONPR(EstimateCompressBound, (unsigned), unsigned), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("bool CompressStream(Serializer&, Deserializer&)",
                                   asFUNCTIONPR(CompressStream, (Serializer&, Deserializer&), bool), asCALL_CDECL);
    // bool DecompressStream(Serializer& dest, Deserializer& src) | File: ../IO/Compression.h
    engine->RegisterGlobalFunction("bool DecompressStream(Serializer&, Deserializer&)",
                                   asFUNCTIONPR(DecompressStream, (Serializer&, Deserializer&), bool), asCALL_CDECL);
    // VectorBuffer CompressVectorBuffer(VectorBuffer& src) | File: ../IO/Compression.h
    engine->RegisterGlobalFunction("VectorBuffer CompressVectorBuffer(VectorBuffer&)",
                                   asFUNCTIONPR(CompressVectorBuffer, (VectorBuffer&), VectorBuffer), asCALL_CDECL);
    // VectorBuffer DecompressVectorBuffer(VectorBuffer& src) | File: ../IO/Compression.h
    engine->RegisterGlobalFunction("VectorBuffer DecompressVectorBuffer(VectorBuffer&)",
                                   asFUNCTIONPR(DecompressVectorBuffer, (VectorBuffer&), VectorBuffer), asCALL_CDECL);
    // void SplitPath(const String& fullPath, String& pathName, String& fileName, String& extension, bool
    // lowercaseExtension=true) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("void SplitPath(const String&in, String&, String&, String&, bool = true)",
                                   asFUNCTIONPR(SplitPath, (const String&, String&, String&, String&, bool), void),
                                   asCALL_CDECL);
    // String GetPath(const String& fullPath) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String GetPath(const String&in)", asFUNCTIONPR(GetPath, (const String&), String),
                                   asCALL_CDECL);
    // String GetFileName(const String& fullPath) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String GetFileName(const String&in)",
                                   asFUNCTIONPR(GetFileName, (const String&), String), asCALL_CDECL);
    // String GetExtension(const String& fullPath, bool lowercaseExtension=true) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String GetExtension(const String&in, bool = true)",
                                   asFUNCTIONPR(GetExtension, (const String&, bool), String), asCALL_CDECL);
    // String GetFileNameAndExtension(const String& fileName, bool lowercaseExtension=false) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String GetFileNameAndExtension(const String&in, bool = false)",
                                   asFUNCTIONPR(GetFileNameAndExtension, (const String&, bool), String), asCALL_CDECL);
    // String ReplaceExtension(const String& fullPath, const String& newExtension) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String ReplaceExtension(const String&in, const String&in)",
                                   asFUNCTIONPR(ReplaceExtension, (const String&, const String&), String),
                                   asCALL_CDECL);
    // String AddTrailingSlash(const String& pathName) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String AddTrailingSlash(const String&in)",
                                   asFUNCTIONPR(AddTrailingSlash, (const String&), String), asCALL_CDECL);
    // String RemoveTrailingSlash(const String& pathName) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String RemoveTrailingSlash(const String&in)",
                                   asFUNCTIONPR(RemoveTrailingSlash, (const String&), String), asCALL_CDECL);
    // String GetParentPath(const String& path) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String GetParentPath(const String&in)",
                                   asFUNCTIONPR(GetParentPath, (const String&), String), asCALL_CDECL);
    // String GetInternalPath(const String& pathName) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String GetInternalPath(const String&in)",
                                   asFUNCTIONPR(GetInternalPath, (const String&), String), asCALL_CDECL);
    // String GetNativePath(const String& pathName) | File: ../IO/FileSystem.h
    engine->RegisterGlobalFunction("String GetNativePath(const String&in)",
                                   asFUNCTIONPR(GetNativePath, (const String&), String), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("bool IsAbsolutePath(const String&in)",
                                   asFUNCTIONPR(IsAbsolutePath, (const String&), bool), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("bool Equals(float, float)", asFUNCTIONPR(Equals, (float, float), bool),
                                   asCALL_CDECL);
    // template<class T, class U> T Lerp(T lhs, T rhs, U t) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("float Lerp(float, float, float)", asFUNCTIONPR(Lerp, (float, float, float), float),
                                   asCALL_CDECL);
    // template<class T> T InverseLerp(T lhs, T rhs, T x) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("float InverseLerp(float, float, float)",
                                   asFUNCTIONPR(InverseLerp, (float, float, float), float), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("uint FloatToRawIntBits(float)", asFUNCTIONPR(FloatToRawIntBits, (float), unsigned),
                                   asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("float Clamp(float, float, float)",
                                   asFUNCTIONPR(Clamp, (float, float, float), float), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("float SmoothStep(float, float, float)",
                                   asFUNCTIONPR(SmoothStep, (float, float, float), float), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("float Atan2(float, float)", asFUNCTIONPR(Atan2, (float, float), float),
                                   asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("bool IsPowerOfTwo(uint)", asFUNCTIONPR(IsPowerOfTwo, (unsigned), bool),
                                   asCALL_CDECL);
    // unsigned NextPowerOfTwo(unsigned value) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("uint NextPowerOfTwo(uint)", asFUNCTIONPR(NextPowerOfTwo, (unsigned), unsigned),
                                   asCALL_CDECL);
    // unsigned ClosestPowerOfTwo(unsigned value) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("uint ClosestPowerOfTwo(uint)",
                                   asFUNCTIONPR(ClosestPowerOfTwo, (unsigned), unsigned), asCALL_CDECL);
    // unsigned LogBaseTwo(unsigned value) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("uint LogBaseTwo(uint)", asFUNCTIONPR(LogBaseTwo, (unsigned), unsigned),
                                   asCALL_CDECL);
    // unsigned CountSetBits(unsigned value) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("uint CountSetBits(uint)", asFUNCTIONPR(CountSetBits, (unsigned), unsigned),
                                   asCALL_CDECL);
    // constexpr unsigned SDBMHash(unsigned hash, unsigned char c) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("uint SDBMHash(uint, uint8)",
                                   asFUNCTIONPR(SDBMHash, (unsigned, unsigned char), unsigned), asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("float Random(float, float)", asFUNCTIONPR(Random, (float, float), float),
                                   asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("float RandomNormal(float, float)",
                                   asFUNCTIONPR(RandomNormal, (float, float), float), asCALL_CDECL);
    // unsigned short FloatToHalf(float value) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("uint16 FloatToHalf(float)", asFUNCTIONPR(FloatToHalf, (float), unsigned short),
                                   asCALL_CDECL);
    // float HalfToFloat(unsigned short value) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("float HalfToFloat(uint16)", asFUNCTIONPR(HalfToFloat, (unsigned short), float),
                                   asCALL_CDECL);
    // void SinCos(float angle, float& sin, float& cos) | File: ../Math/MathDefs.h
    engine->RegisterGlobalFunction("void SinCos(float, float&, float&)",
                                   asFUNCTIONPR(SinCos, (float, float&, float&), void), asCALL_CDECL);
    // void SetRandomSeed(unsigned seed) | File: ../Math/Random.h
    engine->RegisterGlobalFunction("void SetRandomSeed(uint)", asFUNCTIONPR(SetRandomSeed, (unsigned), void),
                                   asCALL_CDECL);
    ...
    engine->RegisterGlobalFunction("float RandStandardNormal()", asFUNCTIONPR(RandStandardNormal, (), float),
                                   asCALL_CDECL);
    // Vector2 VectorLerp(const Vector2& lhs, const Vector2& rhs, const Vector2& t) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("Vector2 VectorLerp(const Vector2&in, const Vector2&in, const Vector2&in)",
                                   asFUNCTIONPR(VectorLerp, (const Vector2&, const Vector2&, const Vector2&), Vector2),
                                   asCALL_CDECL);
    // Vector2 VectorMin(const Vector2& lhs, const Vector2& rhs) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("Vector2 VectorMin(const Vector2&in, const Vector2&in)",
                                   asFUNCTIONPR(VectorMin, (const Vector2&, const Vector2&), Vector2), asCALL_CDECL);
    // Vector2 VectorMax(const Vector2& lhs, const Vector2& rhs) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("Vector2 VectorMax(const Vector2&in, const Vector2&in)",
                                   asFUNCTIONPR(VectorMax, (const Vector2&, const Vector2&), Vector2), asCALL_CDECL);
    // Vector2 VectorFloor(const Vector2& vec) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("Vector2 VectorFloor(const Vector2&in)",
                                   asFUNCTIONPR(VectorFloor, (const Vector2&), Vector2), asCALL_CDECL);
    // Vector2 VectorRound(const Vector2& vec) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("Vector2 VectorRound(const Vector2&in)",
                                   asFUNCTIONPR(VectorRound, (const Vector2&), Vector2), asCALL_CDECL);
    // Vector2 VectorCeil(const Vector2& vec) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("Vector2 VectorCeil(const Vector2&in)",
                                   asFUNCTIONPR(VectorCeil, (const Vector2&), Vector2), asCALL_CDECL);
    // Vector2 VectorAbs(const Vector2& vec) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("Vector2 VectorAbs(const Vector2&in)",
                                   asFUNCTIONPR(VectorAbs, (const Vector2&), Vector2), asCALL_CDECL);
    // IntVector2 VectorFloorToInt(const Vector2& vec) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("IntVector2 VectorFloorToInt(const Vector2&in)",
                                   asFUNCTIONPR(VectorFloorToInt, (const Vector2&), IntVector2), asCALL_CDECL);
    // IntVector2 VectorRoundToInt(const Vector2& vec) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("IntVector2 VectorRoundToInt(const Vector2&in)",
                                   asFUNCTIONPR(VectorRoundToInt, (const Vector2&), IntVector2), asCALL_CDECL);
    // IntVector2 VectorCeilToInt(const Vector2& vec) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("IntVector2 VectorCeilToInt(const Vector2&in)",
                                   asFUNCTIONPR(VectorCeilToInt, (const Vector2&), IntVector2), asCALL_CDECL);
    // IntVector2 VectorMin(const IntVector2& lhs, const IntVector2& rhs) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("IntVector2 VectorMin(const IntVector2&in, const IntVector2&in)",
                                   asFUNCTIONPR(VectorMin, (const IntVector2&, const IntVector2&), IntVector2),
                                   asCALL_CDECL);
    // IntVector2 VectorMax(const IntVector2& lhs, const IntVector2& rhs) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("IntVector2 VectorMax(const IntVector2&in, const IntVector2&in)",
                                   asFUNCTIONPR(VectorMax, (const IntVector2&, const IntVector2&), IntVector2),
                                   asCALL_CDECL);
    // IntVector2 VectorAbs(const IntVector2& vec) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("IntVector2 VectorAbs(const IntVector2&in)",
                                   asFUNCTIONPR(VectorAbs, (const IntVector2&), IntVector2), asCALL_CDECL);
    // float StableRandom(const Vector2& seed) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("float StableRandom(const Vector2&in)",
                                   asFUNCTIONPR(StableRandom, (const Vector2&), float), asCALL_CDECL);
    // float StableRandom(float seed) | File: ../Math/Vector2.h
    engine->RegisterGlobalFunction("float StableRandom(float)", asFUNCTIONPR(StableRandom, (float), float),
                                   asCALL_CDECL);
    // Vector3 VectorLerp(const Vector3& lhs, const Vector3& rhs, const Vector3& t) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("Vector3 VectorLerp(const Vector3&in, const Vector3&in, const Vector3&in)",
                                   asFUNCTIONPR(VectorLerp, (const Vector3&, const Vector3&, const Vector3&), Vector3),
                                   asCALL_CDECL);
    // Vector3 VectorMin(const Vector3& lhs, const Vector3& rhs) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("Vector3 VectorMin(const Vector3&in, const Vector3&in)",
                                   asFUNCTIONPR(VectorMin, (const Vector3&, const Vector3&), Vector3), asCALL_CDECL);
    // Vector3 VectorMax(const Vector3& lhs, const Vector3& rhs) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("Vector3 VectorMax(const Vector3&in, const Vector3&in)",
                                   asFUNCTIONPR(VectorMax, (const Vector3&, const Vector3&), Vector3), asCALL_CDECL);
    // Vector3 VectorFloor(const Vector3& vec) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("Vector3 VectorFloor(const Vector3&in)",
                                   asFUNCTIONPR(VectorFloor, (const Vector3&), Vector3), asCALL_CDECL);
    // Vector3 VectorRound(const Vector3& vec) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("Vector3 VectorRound(const Vector3&in)",
                                   asFUNCTIONPR(VectorRound, (const Vector3&), Vector3), asCALL_CDECL);
    // Vector3 VectorCeil(const Vector3& vec) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("Vector3 VectorCeil(const Vector3&in)",
                                   asFUNCTIONPR(VectorCeil, (const Vector3&), Vector3), asCALL_CDECL);
    // Vector3 VectorAbs(const Vector3& vec) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("Vector3 VectorAbs(const Vector3&in)",
                                   asFUNCTIONPR(VectorAbs, (const Vector3&), Vector3), asCALL_CDECL);
    // IntVector3 VectorFloorToInt(const Vector3& vec) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("IntVector3 VectorFloorToInt(const Vector3&in)",
                                   asFUNCTIONPR(VectorFloorToInt, (const Vector3&), IntVector3), asCALL_CDECL);
    // IntVector3 VectorRoundToInt(const Vector3& vec) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("IntVector3 VectorRoundToInt(const Vector3&in)",
                                   asFUNCTIONPR(VectorRoundToInt, (const Vector3&), IntVector3), asCALL_CDECL);
    // IntVector3 VectorCeilToInt(const Vector3& vec) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("IntVector3 VectorCeilToInt(const Vector3&in)",
                                   asFUNCTIONPR(VectorCeilToInt, (const Vector3&), IntVector3), asCALL_CDECL);
    // IntVector3 VectorMin(const IntVector3& lhs, const IntVector3& rhs) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("IntVector3 VectorMin(const IntVector3&in, const IntVector3&in)",
                                   asFUNCTIONPR(VectorMin, (const IntVector3&, const IntVector3&), IntVector3),
                                   asCALL_CDECL);
    // IntVector3 VectorMax(const IntVector3& lhs, const IntVector3& rhs) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("IntVector3 VectorMax(const IntVector3&in, const IntVector3&in)",
                                   asFUNCTIONPR(VectorMax, (const IntVector3&, const IntVector3&), IntVector3),
                                   asCALL_CDECL);
    // IntVector3 VectorAbs(const IntVector3& vec) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("IntVector3 VectorAbs(const IntVector3&in)",
                                   asFUNCTIONPR(VectorAbs, (const IntVector3&), IntVector3), asCALL_CDECL);
    // float StableRandom(const Vector3& seed) | File: ../Math/Vector3.h
    engine->RegisterGlobalFunction("float StableRandom(const Vector3&in)",
                                   asFUNCTIONPR(StableRandom, (const Vector3&), float), asCALL_CDECL);
    // Vector4 VectorLerp(const Vector4& lhs, const Vector4& rhs, const Vector4& t) | File: ../Math/Vector4.h
    engine->RegisterGlobalFunction("Vector4 VectorLerp(const Vector4&in, const Vector4&in, const Vector4&in)",
                                   asFUNCTIONPR(VectorLerp, (const Vector4&, const Vector4&, const Vector4&), Vector4),
                                   asCALL_CDECL);
    // Vector4 VectorMin(const Vector4& lhs, const Vector4& rhs) | File: ../Math/Vector4.h
    engine->RegisterGlobalFunction("Vector4 VectorMin(const Vector4&in, const Vector4&in)",
                                   asFUNCTIONPR(VectorMin, (const Vector4&, const Vector4&), Vector4), asCALL_CDECL);
    // Vector4 VectorMax(const Vector4& lhs, const Vector4& rhs) | File: ../Math/Vector4.h
    engine->RegisterGlobalFunction("Vector4 VectorMax(const Vector4&in, const Vector4&in)",
                                   asFUNCTIONPR(VectorMax, (const Vector4&, const Vector4&), Vector4), asCALL_CDECL);
    // Vector4 VectorFloor(const Vector4& vec) | File: ../Math/Vector4.h
    engine->RegisterGlobalFunction("Vector4 VectorFloor(const Vector4&in)",
                                   asFUNCTIONPR(VectorFloor, (const Vector4&), Vector4), asCALL_CDECL);
    // Vector4 VectorRound(const Vector4& vec) | File: ../Math/Vector4.h
    engine->RegisterGlobalFunction("Vector4 VectorRound(const Vector4&in)",
                                   asFUNCTIONPR(VectorRound, (const Vector4&), Vector4), asCALL_CDECL);
    // Vector4 VectorCeil(const Vector4& vec) | File: ../Math/Vector4.h
    engine->RegisterGlobalFunction("Vector4 VectorCeil(const Vector4&in)",
                                   asFUNCTIONPR(VectorCeil, (const Vector4&), Vector4), asCALL_CDECL);
#ifdef URHO3D_NAVIGATION
    ...
    // CompressedFormat format) | File: ../Resource/Decompress.h Error: type "unsigned char*" can not automatically bind
    // void DecompressImageETC(unsigned char* dstImage, const void* blocks, int width, int height, bool hasAlpha) |
    // File: ../Resource/Decompress.h Error: type "unsigned char*" can not automatically bind void
    // DecompressImagePVRTC(unsigned char* rgba, const void* blocks, int width, int height, CompressedFormat format) |
    // File: ../Resource/Decompress.h Error: type "unsigned char*" can not automatically bind void
    // FlipBlockVertical(unsigned char* dest, const unsigned char* src, CompressedFormat format) | File:
    // ../Resource/Decompress.h Error: type "unsigned char*" can not automatically bind void
    // FlipBlockHorizontal(unsigned char* dest, const unsigned char* src, CompressedFormat format) | File:
    // ../Resource/Decompress.h Error: type "unsigned char*" can not automatically bind const String&
    // GetResourceName(Resource* resource) | File: ../Resource/Resource.h
    engine->RegisterGlobalFunction("const String& GetResourceName(Resource@+)",
                                   asFUNCTIONPR(GetResourceName, (Resource*), const String&), asCALL_CDECL);
    // StringHash GetResourceType(Resource* resource, StringHash defaultType) | File: ../Resource/Resource.h
    engine->RegisterGlobalFunction("StringHash GetResourceType(Resource@+, StringHash)",
                                   asFUNCTIONPR(GetResourceType, (Resource*, StringHash), StringHash), asCALL_CDECL);
    // ResourceRef GetResourceRef(Resource* resource, StringHash defaultType) | File: ../Resource/Resource.h
    engine->RegisterGlobalFunction("ResourceRef GetResourceRef(Resource@+, StringHash)",
                                   asFUNCTIONPR(GetResourceRef, (Resource*, StringHash), ResourceRef), asCALL_CDECL);
